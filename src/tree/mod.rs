...
mod test {
    ...
    fn child_hash() {
        ...
        assert_eq!(
            ...
            &[
                55, 117, 237, 218, 211, 229, 17, 220, 31, 157, 190, 119, 142, 84, 152, 160, 22, 17,
                31, 168, 18, 71, 237, 146, 220, 72, 179, 180, 226, 43, 54, 147
            ]
        );
    ...
    fn hash() {
        ...
        assert_eq!(
            tree.hash(),
            [
                231, 160, 28, 226, 3, 175, 131, 125, 126, 180, 235, 64, 148, 196, 36, 31, 159, 22,
                54, 102, 106, 21, 29, 197, 219, 157, 213, 149, 220, 54, 210, 98
            ]
        );
    }
