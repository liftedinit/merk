...
mod test {
    ...
    fn child_hash() -> Result<()> {
        ...
        assert_eq!(
            ...
            &[
                18, 230, 68, 218, 76, 147, 236, 119, 153, 139, 94, 1, 104, 124, 226, 91, 95, 57, 74, 106, 48, 251, 40, 72, 180, 204, 229, 66, 59, 225, 242, 48
            ]
        );
    ...
    fn hash() -> Result<()> {
        ...
        assert_eq!(
            tree.hash(),
            [
                247, 232, 122, 198, 124, 40, 69, 169, 36, 107, 48, 159, 225, 86, 58, 42, 131, 124, 112, 94, 33, 224, 146, 177, 211, 10, 156, 248, 147, 255, 135, 7
            ]
        );
        Ok(())
    }
