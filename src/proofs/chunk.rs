...
mod tests {
    ...
    fn leaf_chunk_roundtrip() {
        ...
        let chunk = verify_leaf(
            ops,
            [
                153, 247, 163, 84, 222, 212, 178, 22, 176, 222, 48, 135, 145, 10, 135, 20, 85, 161,
                110, 84, 109, 97, 22, 81, 239, 4, 211, 186, 45, 219, 25, 32,
            ],
        )
        .unwrap();
        let counts = count_node_types(chunk);
        ...
        let chunk = verify_leaf(
            ops,
            [
                2, 133, 164, 226, 27, 4, 161, 149, 201, 237, 145, 167, 183, 83, 144, 151, 159, 226,
                228, 187, 108, 81, 137, 146, 133, 19, 46, 255, 15, 212, 221, 237,
            ],
        )
        .unwrap();
        let counts = count_node_types(chunk);
